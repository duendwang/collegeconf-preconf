...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Campus'), ['action' => 'edit', $campus->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Campus'), ['action' => 'delete', $campus->id], ['confirm' => __('Are you sure you want to delete # {0}?', $campus->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Campuses'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Campus'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="campuses view content">
            <h3><?= h($campus->name) ?></h3>
            <table>
                <tr>
                    <th><?= __('Name') ?></th>
            ...
            <div class="related">
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($campus->attendees as $attendees) : ?>
                        <tr>
            ...
            <div class="related">
                ...
                <?php if (!empty($campus->potential_attendees)) : ?>
                <div class="table-responsive">
                    <table>
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($campus->potential_attendees as $potentialAttendees) : ?>
                        <tr>
