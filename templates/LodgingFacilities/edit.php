...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $lodgingFacility->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $lodgingFacility->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="lodgingFacilities form content">
            ...
            <fieldset>
                <legend><?= __('Edit Lodging Facility') ?></legend>
                <?php
